...
public class CategoryAPI {
    ...
    @PostMapping(value = "/toann/auth/api/1.0/Category/")
    ...
    @PostMapping(value = "/toann/auth/api/1.0/SubCatgory/")
    ...
    @PutMapping(value = "/toann/auth/api/1.0/Category/{id}")
    ...
    @PutMapping(value = "/toann/auth/api/1.0/SubCategory/{id}")
    ...
    @PutMapping(value = "/toann/auth/api/1.0/SubCategory/{id}/addSubCategory")
    ...
    @PutMapping(value = "/toann/auth/api/1.0/SubCategory/{id}/addProduct")
